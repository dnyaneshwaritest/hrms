    ...
    <>
      <div className='flex justify-center items-center bg-gray-200  h-screen '>
        <div className='shadow-lg w-[400px] bg-white  p-9 flex flex-col justify-center items-center'>
          ...
          <p className='font-bold  text-2xl  text-center'>Password Update <br /> successfully</p>
          <p className='text-sm font-extralight ml-4'>Your password has been update successfully</p>
          <button className='bg-blue-500 text-white mt-4 w-[100%] p-2 '>Back to login</button>
        </div>
